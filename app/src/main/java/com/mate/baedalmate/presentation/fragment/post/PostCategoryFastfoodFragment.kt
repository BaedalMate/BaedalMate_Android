...
class PostCategoryFastfoodFragment : Fragment() {
    ...
    private fun setCategoryClickListener() {
        binding.radiogroupLayoutPostCategoryFastfoodSort.setOnCheckedChangeListener { group, checkedId ->
            when (checkedId) {
                R.id.radiobutton_post_category_fastfood_sort_time -> {
                    getRecruitList(sort = "deadlineDate")
                }
                R.id.radiobutton_post_category_fastfood_sort_star -> {
                    getRecruitList(sort = "score")
                }
                R.id.radiobutton_post_category_fastfood_sort_popular -> {
