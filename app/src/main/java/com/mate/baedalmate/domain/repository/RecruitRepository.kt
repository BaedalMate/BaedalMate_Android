...
interface RecruitRepository {
    suspend fun requestRecruitList(categoryId: Int, page: Int, size: Int, sort: String): Response<RecruitList>
    suspend fun requestRecruitMainList(page: Int, size: Int, sort: String): Response<MainRecruitList>
